...
interface SendNoticeModalProps {
	...
	availableUsers?: User[];
	onClose: () => void;
	onSubmit?: (data: { title: string; authorName?: string; message: string }) => void;
}
				...
				>
					<div>
						...
						<input
							...
							className="w-full rounded-xl bg-[#F9F9F9] px-4 py-3 text-gray-900 focus:outline-none transition-colors border border-gray-200"
							required
						/>
					</div>
					<div>
