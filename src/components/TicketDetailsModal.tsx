...
function getUniformCardFontSize(values: Array<string | number | null | undefined>, maxPx = 20, minPx = 10, baseChars = 9) {
...
export function TicketDetailsModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-xs p-4 overflow-y-auto font-inter">
      <div className="bg-[#F8F9FB] rounded-2xl w-full max-w-4xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden border border-gray-100 animate-in fade-in zoom-in-95 duration-150">
        {/* Scrollable Content */}
        <div className="p-6 overflow-y-auto space-y-6 custom-scrollbar relative">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <button
                onClick={onClose}
                className="w-8 h-8 flex items-center justify-center rounded-lg border border-[#757575] text-[#757575] hover:bg-gray-100 transition-colors cursor-pointer"
              ...
              return (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-xs">
                    ...
                    <h4 style={cardStyle} className="font-bold text-gray-900 mt-1">
                      {details.stakeAmount}
                    </h4>
                  </div>
                  ...
                  <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-xs">
                    ...
                    <h4 style={cardStyle} className={`font-bold mt-1 ${String(details.profit).trim().startsWith("-") ? "text-[#EE201C]" : "text-[#10C300]"}`}>
                      {details.profit}
                    </h4>
                  </div>
                </div>
              ...
              return (
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-xs">
                    ...
                    <h4 style={cardStyle} className="font-bold text-[#10C300] mt-1">
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
            <div className="flex items-center justify-between pb-4 border-b border-gray-100 mb-4">
              ...
              <button
                ...
                className="bg-[#1BAA04] hover:bg-[#158903] text-white px-4 py-1.5 rounded-full text-xs font-semibold shadow-xs transition-colors cursor-pointer whitespace-nowrap"
              >
                View Player Profile
              </button>
            </div>
